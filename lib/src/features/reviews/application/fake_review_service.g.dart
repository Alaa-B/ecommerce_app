...
part of 'fake_review_service.dart';

// **************************************************************************
// RiverpodGenerator
// **************************************************************************

String _$reviewsServiceHash() => r'314c57e04cf2a23826bd8c833c9a3fb035e0a2c2';

/// See also [reviewsService].
@ProviderFor(reviewsService)
final reviewsServiceProvider = AutoDisposeProvider<FakeReviewService>.internal(
  reviewsService,
...
typedef ReviewsServiceRef = AutoDisposeProviderRef<FakeReviewService>;
String _$watchUserReviewsHash() => r'fd7bad28439fdd52de18a3d4ba66225d43ec37ee';
...
String _$fetchUserReviewsHash() => r'2625536c48eb9fe06bddbbb702a4c6879de1beac';
